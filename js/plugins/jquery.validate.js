...
$.extend( $.validator, {
	...
	messages: {
		required: "É obrigatório preencher esse campo",
		...
		rangelength: $.validator.format( "Por favor informe um value between {0} and {1} caracteres long." ),
		...
		min: $.validator.format( "Por favor informe um valor manior ou igual a {0}." ),
		step: $.validator.format( "Por favor informe um multiplo de {0}." )
	},
